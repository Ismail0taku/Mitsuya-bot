/**
 * @param {import('@itsukichan/baileys').WASocket | import('@itsukichan/baileys').WALegacySocket}
 */
function bind(conn) {
    if (!conn.chats) conn.chats = {}
    /**
     * 
     * @param {import('@itsukichan/baileys').Contact[]|{contacts:import('@itsukichan/baileys').Contact[]}} contacts 
     * @returns 
     */
