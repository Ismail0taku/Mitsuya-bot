...
import { prepareWAMessageMedia, generateWAMessageFromContent } from '@itsukichan/baileys';
...
const handler = async (m, {conn, isROwner, usedPrefix, command, text}) => {
  ...
  const images = ['https://files.catbox.moe/ss0f2l.jpg', 'https://files.catbox.moe/ss0f2l.jpg','https://files.catbox.moe/ss0f2l.jpg', 'https://files.catbox.moe/ss0f2l.jpg'];
...
handler.command = /^(باتش|شيشانشوسي)$/i;
