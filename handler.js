...
const { proto } = (await import('@itsukichan/baileys')).default
...
m.reply(`⚠️ ESTAS BANEADO ⚠️\n*• Motivo:* ${user.messageSpam === 0 ? 'Spam' : user.messageSpam}\n*👉🏻 Puedes contactar al propietario del Bot si crees أن هذا خطأ أو للمحادثة حول إزالة الحظر*\n\n👉 ${global.fb}`)
user.antispam++	
return
}
...
conn.sendMessage(m.chat, {text: `*⧼🚫┊لـيـس لـديـك الـمـاس┊🚫⧽\n> لـلـشـراء الالـمـاس اكـتـب\n\n.شراء (العدد)\n${global.gt}*`, contextInfo: {externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": global.wm, body: '', previewType: 0, "thumbnail": global.img.getRandom(), sourceUrl: [global.nna, global.nna2, global.md, global.yt, global.nnn, global.nnnt, global.nnnttt, global.tiktok].getRandom()}}}, { quoted: m })         
continue
}
if (plugin.level > _user.level) {
conn.sendMessage(m.chat, {text: `*⚠️𝐍𝐞𝐜𝐞𝐬𝐢𝐭𝐚 𝐞𝐥 𝐧𝐢𝐯𝐞𝐥 ${plugin.level} 𝐩𝐚𝐫𝐚 𝐩𝐨𝐝𝐞𝐫 𝐮𝐬𝐚𝐫 𝐞𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨, 𝐓𝐮 𝐧𝐢𝐯𝐞𝐥 𝐚𝐜𝐭𝐮𝐚𝐥 𝐞𝐬:* ${_user.level}`, contextInfo: {externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": global.wm, body: '', previewType: 0, "thumbnail": global.img.getRandom(), sourceUrl: [global.nna, global.nna2, global.md, global.yt, global.nnn, global.nnnt, global.nnnttt, global.tiktok].getRandom()}}}, { quoted: m })         
continue 
}
...
if (m.limit) m.reply(`لـقـد قـمـت بـي انـفـاق *˼${+m.limit}˹* الـمـاس💎`)
if (m.money) m.reply(+m.money + 'مـال كاكاشي 💵') 
}
break
}}} catch (e) {
console.error(e)
...
if (!m.fromMem && m.text.match(/(@201153573240|كاكاشي|كاكاشي بوت|البوت|بوت)/gi)) {
...
if (chat.welcome) {
              ...
              for (let user of participants) {
                ...
                try {
                  ...
                  pp = 'https://files.catbox.moe/m2budk.jpg'; 
                  ppgp = 'https://files.catbox.moe/m2budk.jpg'; 
                } finally {
                  ...
                  let welcomeApiUrl = `https://api.popcat.xyz/welcomecard?background=${encodeURIComponent(
                    'https://files.catbox.moe/m2budk.jpg'
              ...
              for (let user of participants) {
                ...
                try {
                  ...
                  let leaveApiUrl = `https://api.popcat.xyz/welcomecard?background=${encodeURIComponent(
                    'https://files.catbox.moe/1udvd0.jpg'
                  )}&text1=${encodeURIComponent(
                    await this.getName(user)
...
if (nk.isGroup == false) {
if (nk.status == "offer") {
let callmsg = await this.reply(nk.from, `ʜᴏʟᴀ *@${nk.from.split('@')[0]}*, ʟᴀs ${nk.isVideo ? 'videollamadas' : 'llamadas'} ɴᴏ ᴇsᴛᴀɴ ᴘᴇʀᴍɪᴛɪᴅᴀs, sᴇʀᴀs ʙʟᴏǫᴜᴇᴀᴅᴏ.\n\nsɪ ᴀᴄᴄɪᴅᴇɴᴛᴀʟᴍᴇɴᴛᴇ ʟʟᴀᴍᴀsᴛᴇ ᴘᴏɴɢᴀsᴇ ᴇɴ ᴄᴏɴᴛᴀᴄᴛᴏ ᴄᴏɴ ᴍɪ ᴄʀᴇᴀᴅᴏʀ ᴘᴀʀᴀ ǫᴜᴇ ᴛᴇ ᴅᴇsʙʟᴏǫᴜᴇᴇ!\n\nɢʀᴜᴘᴏ ᴀsɪsᴛᴇɴᴄɪᴀ ғᴀᴄᴇʙᴏᴏᴋ: ${global.fb}`, false, { mentions: [nk.from] })
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝙼𝙰𝙸 𝙰𝙸;;;\nFN:✦ 𝑲𝑨𝑲𝑨𝑺𝑯𝑰 𝑼𝑷𝑫𝑨𝑻𝑬𝑺 ✦\nORG:𝙼𝙰𝙸 𝙰𝙸\nTITLE:\nitem1.TEL;waid=201153573240:+201153573240\nitem1.X-ABLabel:✦ 𝑲𝑨𝑲𝑨𝑺𝑯𝑰 𝑼𝑷𝑫𝑨𝑻𝙴𝑺 ✦\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:✦ 𝑲𝑨𝑲𝑨𝑺𝑯𝑰 𝑼𝑷𝑫𝑨𝑻𝑬𝑺 ✦\nEND:VCARD`
await this.sendMessage(nk.from, { contacts: { displayName: '𝙼𝙰𝙸 𝙰𝙸', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    const comando = (m.command || m.text.split(' ')[0] || '').trim()
    
    let msg = {
    rowner: `
◉━━━━━━✦━━━━━━◉
┃ ✨ الأمر *${comando}* مخصص فقط لي مطور البوت.
◉━━━━━━✦━━━━━━◉`,
...
◉━━━━━━✦━━━━━━◉`,
    ...
    mods: `
◉━━━━━━✦━━━━━━◉
┃ ☁️ الأمر *${comando}* يمكن استخدامه من قِبل المشرفين فقط.
┃ (｡•́︿•̀｡)
◉━━━━━━✦━━━━━━◉`,

    premium: `
◉━━━━━━✦━━━━━━◉
┃ 💎 هذا الأمر مخصص فقط لمستخدمي النسخة المميزة كن مميز لي استخدام الامر 😎
◉━━━━━━✦━━━━━━◉`,

    group: `
◉━━━━━━✦━━━━━━◉
┃ 🏮 الأمر *${comando}* يعمل فقط داخل المجموعات 
◉━━━━━━✦━━━━━━◉`,

    private: `
◉━━━━━━✦━━━━━━◉
┃ 📜 الأمر *${comando}* متاح فقط في الخاص.
◉━━━━━━✦━━━━━━◉`,

    admin: `
◉━━━━━━✦━━━━━━◉
┃ ⚠️ الأمر فقط لمشرفي المجموعة! 🚀
◉━━━━━━✦━━━━━━◉`,

    botAdmin: `
◉━━━━━━✦━━━━━━◉
┃ 😠  يجب أن أكون مشرفًا لأتمكن من تنفيذ الأمر *${comando}*!
◉━━━━━━✦━━━━━━◉`,

    unreg: `˼🚫˹ أنـت لـسـت مـسـجـلًا فـي قـاعـدة الـبـيـانـات. \n📌 لـلتـسـجـيـل اسـتـخـدم: #تسجيـل اسمـك.عمـرك \n✍️ مـثـال: #تسجيـل احمد.21`,

    restrict: `
◉━━━━━━✦━━━━━━◉
┃ 🚫 هذا الأمر غير مفعل حالياً من قبل المطور.
◉━━━━━━✦━━━━━━◉`
}[type];

    if (msg) return conn.sendMessage(m.chat, {text: msg, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363340261499294@newsletter', serverMessageId: '', newsletterName: '✦ 𝑲𝑨𝑲𝑨𝑺𝑯𝑰 𝑼𝑷𝑫𝑨𝑻𝑬𝑺 ✦' }, externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": `❗ مـلاحـظـه ❗`, body: global.wm, previewType: 0, "thumbnail": global.img.getRandom(), sourceUrl: [global.nna, global.nna2, global.md, global.yt, global.nn, global.tiktok].getRandom()}}}, { quoted: m })
}
